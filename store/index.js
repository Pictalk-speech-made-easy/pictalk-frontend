...
export const actions = {
  ...
  addPicto(vuexContext, picto, collection_nb) {
    ...
    return axios.post(URL + "/pictalk/picto/" + collection_nb, picto).then(() => {
  ...
  editPicto(vuexContext, editedPicto, collection_nb) {
    ...
    return axios
      .put(URL + "/pictalk/picto/" + collection_nb + "/" +
        editedPicto.id,
        editedPicto
      )
      .then(res =>
  ...
  removePicto(vuexContext, removedPicto) {
    return axios.delete(URL + "/pictalk/picto/" + removedPicto.id)
      .then(() => {
  ...
  addCollection(vuexContext, collection) {
    return axios.post(URL + "/pictalk/collection", collection)
      .then(() => vuexContext.commit('addCollection', {
        ...collection,
        id: result.data.id
      }))
      .catch(e => console.log(e));
  ...
  editCollection(vuexContext, editedCollection) {
    return axios.put(URL + "/pictalk/collection/" + editedCollection.id, editedCollection)
      .then(() => vuexContext.commit('editCollection', editedCollection))
      .catch(e => console.log(e));
  },
  removeCollection(vuexContext, removedCollection) {
    return axios.delete(URL + "/pictalk/collection/" + editedCollection.id)
