<template>
        <div>
                <div class="columns is-mobile noscroll">
                        <div :class="!($route.query.fatherCollectionId == $store.getters.getSidebarId) && isSidebarUsed
                                ...
                                <div v-if="pictos.length == 0 && !isPictoListPartial">
                                        ...
                                        <b-image data-cy="cypress-emptyCollection" style="aspect-ratio: 1/1"
                                                class="emptyCollection2" lazy
                                ...
                                <div v-else>
                                        <b-image data-cy="cypress-noConnection" style="aspect-ratio: 1/1"
                                                class="partialCollection" lazy
                        ...
                        <div v-if="!($route.query.fatherCollectionId == $store.getters.getSidebarId) && isSidebarUsed"
                                class="
          is-4-mobile
          is-3-tablet
          is-2-desktop
          ...
          lessPadding
        ">
                                <b-image style="aspect-ratio: 1/1" v-if="sidebarPictos.length == 0"
                                        class="emptyCollection2" lazy
                                        alt="An empty cardboard box that represents an empty collection with no pictograms"
                                        :srcset="require('@/assets/EmptyCollection3.png').srcSet" />
                ...
                <div class="contenant">
                        <pictoBar :style="loadSpeech.length != 0
                                ...
                                " class="pictobar sidebar slide-up" :pictos="loadSpeech"
