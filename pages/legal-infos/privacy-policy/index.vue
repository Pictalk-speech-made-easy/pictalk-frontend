<template>
	<div class="container">
		...
		<p>
			Your privacy is important to us. It is Pictalk&#39;s policy to
		...
		<p>This policy is effective as of 16 February 2021.</p>
		<p>Last updated: 16 February 2021</p>
		<br />
		<h3 class="title is-3">Information We Collect</h3>
		<p>
		...
		<br />
		<h4 class="title is-4">User-Generated Content</h4>
		<p>
			...
			users for the purpose of publication, processing, or usage on our
			platform. All user-generated content is associated with the account
		...
		<br />
		<h4 class="title is-4">Transaction Data</h4>
		<p>
		...
		<br />
		<h4 class="title is-4">Collection and Use of Information</h4>
		<p>
		...
		<br />
		<h4 class="title is-4">Security of Your Personal Information</h4>
		<p>
		...
		<br />
		<h4 class="title is-4">How Long We Keep Your Personal Information</h4>
		<p>
		...
		<br />
		<h3 class="title is-3">Children’s Privacy</h3>
		<p>
		...
		<br />
		<h3 class="title is-3">Use of Cookies</h3>
		<p>
		...
		<br />
		<h3 class="title is-3">Business Transfers</h3>
		<p>
		...
		<br />
		<h3 class="title is-3">Limits of Our Policy</h3>
		<p>
		...
		<br />
		<h3 class="title is-3">Changes to This Policy</h3>
		<p>
		...
		<p>
			Where the disclosure of your personal information is solely subject
			to Australian privacy laws, you acknowledge that some third parties
			may not be regulated by the Privacy Act and the Australian Privacy
			Principles in the Privacy Act. You acknowledge that if any such
			third party engages in any act or practice that contravenes the
			Australian Privacy Principles, it would not be accountable under the
			Privacy Act, and you will not be able to seek redress under the
			Privacy Act.
		</p>
		<br />
		<h3 class="title is-3">
		...
		<br />
		<h4 class="title is-4">Data Controller / Data Processor</h4>
		<p>
			...
			processors&rdquo;). We, Pictalk, located at the address provided in
		...
		<br />
		<h5 class="title is-5">Consent From You</h5>
		<p>
			...
			When you contact us, you may consent to your name and email address
			being used so we can respond to your enquiry. While you may request
			that we delete your contact details at any time, we cannot recall
			any email we have already sent. If you have any further enquiries
			about how to withdraw your consent, please feel free to enquire
			using the details provided in the Contact Us section of this privacy
			policy.
		</p>
		<br />
		<h5 class="title is-5">Performance of a Contract or Transaction</h5>
		<p>
		...
		<br />
		<h5 class="title is-5">Our Legitimate Interests</h5>
		<p>
		...
		<br />
		<h5 class="title is-5">Compliance with Law</h5>
		<p>
		...
		<p>
			...
			considering your objection in relation to processing on the basis of
		...
		<p>
			...
			must provide compelling legitimate grounds for the processing which
		...
		<p>
			...
			a copy of the personal information we hold about you. Where
		...
		<p>
			...
			information, we will let you know how the deletion affects your use
			of our website or products and services. There may be exceptions to
			this right for specific legal reasons which, if applicable, we will
			set out for you in response to your request. If you terminate or
			delete your account, we will delete your personal information within
			14 days of the deletion of your account. Please be aware that search
		...
		<br />
		<h4 class="title is-4">Do Not Track</h4>
		<p>
		...
		<br />
		<h4 class="title is-4">Cookies and Pixels</h4>
		<p>
		...
		<br />
		<h4 class="title is-4">CCPA-permitted financial incentives</h4>
		<p>
		...
		<br />
		<h4 class="title is-4">California Notice of Collection</h4>
		<p>
		...
		<br />
		<h4 class="title is-4">Right to Know and Delete</h4>
		<p>
		...
		<br />
		<h4 class="title is-4">Shine the Light</h4>
		<p>
			...
			as defined by California’s &ldquo;Shine the Light&rdquo; with third
		...
		<p>
			Alexandros SIDIRAS GALANTE<br />
			alexandros.sidiras@laposte.net
		</p>
	</div>
</template>
