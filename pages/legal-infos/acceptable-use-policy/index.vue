<template>
    <div class="container">
        <h2 class="title is-1">Acceptable Use Policy</h2>
<p>This acceptable use policy covers the products, services, and technologies (collectively referred to as the &ldquo;Products&rdquo;) provided by Pictalk under any ongoing agreement. It’s designed to protect us, our customers, and the general Internet community from unethical, irresponsible, and illegal activity. </p>
<p>Pictalk customers found engaging in activities prohibited by this acceptable use policy can be liable for service suspension and account termination. In extreme cases, we may be legally obliged to report such customers to the relevant authorities. </p>
<p>This policy was last reviewed on 16 February 2021. </p>
<br><h3 class="title is-3">Fair use</h3>
...
<br><h3 class="title is-3">Customer accountability</h3>
...
<br><h3 class="title is-3">Prohibited activity</h3>
<br><h4 class="title is-4">Copyright infringement and access to unauthorized material</h4>
...
<br><h4 class="title is-4">SPAM and unauthorized message activity</h4>
...
<br><h4 class="title is-4">Unethical, exploitative, and malicious activity</h4>
...
<br><h4 class="title is-4">Unauthorized use of Pictalk property</h4>
<p>We prohibit the impersonation of Pictalk, the representation of a significant business relationship with Pictalk, or ownership of any Pictalk property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage, or user trust. </p>
<br><h3 class="title is-3">About this policy</h3>
