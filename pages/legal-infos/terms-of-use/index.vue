<template>
	<div class="container">
		...
		<p>
			...
			website or using any other services provided by Pictalk.
		</p>
		<p>
			We, Pictalk, reserve the right to review and amend any of these
		...
		<br />
		<h3 class="title is-3">Limitations of Use</h3>
		<p>
		...
		<ol>
			...
			<li>
				...
				networks or any other service Pictalk provides;
			</li>
			<li>
		...
		<br />
		<h3 class="title is-3">Intellectual Property</h3>
		<p>
			The intellectual property in the materials contained in this website
			are owned by or licensed to Pictalk and are protected by applicable
		...
		<br />
		<h3 class="title is-3">User-Generated Content</h3>
		<p>
		...
		<br />
		<h3 class="title is-3">Liability</h3>
		<p>
			Our website and the materials on our website are provided on an 'as
			is' basis. To the extent permitted by law, Pictalk makes no
		...
		<p>
			In no event shall Pictalk or its suppliers be liable for any
			...
			materials on this website, even if Pictalk or an authorized
		...
		<br />
		<h3 class="title is-3">Accuracy of Materials</h3>
		<p>
			The materials appearing on our website are not comprehensive and are
			for general information purposes only. Pictalk does not warrant or
		...
		<br />
		<h3 class="title is-3">Severance</h3>
		<p>
		...
		<br />
		<h3 class="title is-3">Governing Law</h3>
		<p>
			These Terms of Service are governed by and construed in accordance
			with the laws of France. You irrevocably submit to the exclusive
